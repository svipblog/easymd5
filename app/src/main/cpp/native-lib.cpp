...
extern "C" JNIEXPORT jstring JNICALL Java_dev_svip_easymd5_MainActivity_mdString(
...
extern "C" JNIEXPORT jstring JNICALL Java_dev_svip_easymd5_MainActivity_mdFile(
        JNIEnv *env, jobject obj, jstring str) {
...
/* forward declaration */
static void Transform(UINT4 pInt[4], UINT4 pInt1[16]);
